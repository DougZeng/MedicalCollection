...
public class StrUtil {
    ...
    public static void main(String[] args) {
        String hexstr = "02 40 62 31 38 2E 36 35 35 30 66 EF 0D";
        String trim = hexstr.replace(" ", "");
//        byte[] bytes = hexStringToBytes(trim);
//        String s = bytesToAscii(bytes, 0, 13);
//        System.out.println("s = " + s);
        StrUtil strToHex = new StrUtil();
        ...
        System.out.println("Hex : " + trim);
        System.out.println("ASCII : " + strToHex.convertHexToString(trim));
