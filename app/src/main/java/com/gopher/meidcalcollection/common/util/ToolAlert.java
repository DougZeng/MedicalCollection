...
public class ToolAlert {
    ...
    public static void toastShort(String msg) {
        Toast.makeText(App.gainContext(), msg, Toast.LENGTH_SHORT).show();
    }
    ...
    public static void toastLong(String msg) {
        Toast.makeText(App.gainContext(), msg, Toast.LENGTH_LONG).show();
    }
    ...
    public static void toast(String msg, int duration) {
        Toast.makeText(App.gainContext(), msg, duration).show();
    }
    ...
    public static PopupWindow popwindow(Context context, View anchor, int viewId, int xoff, int yoff) {
        ...
        PopupWindow pw = new PopupWindow(menuView, LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT, true);
    ...
    public static PopupWindow popwindow(View anchor, View popView, int xoff, int yoff) {
        PopupWindow pw = new PopupWindow(popView, LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT, true);
        pw.setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        pw.setOutsideTouchable(true);
        pw.showAsDropDown(anchor, xoff, yoff);
        pw.update();
    ...
    public static PopupWindow popwindowLoction(PopupWindow pw, View anchor, View popView, Direction direction) {
        ...
        switch (direction) {
            ...
            case RIGHT:
                if (pw.isShowing()) {
                    pw.update(location[0] + anchor.getWidth(), location[1], LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT);
                } else {
    ...
    public static void notification(Context mContext, NotificationMessage message) {
        ...
        Notification notification = new Notification.Builder(mContext)
                ...
                .setContentText(message.getStatusBarText())
